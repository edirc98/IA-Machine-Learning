...
CREATE TABLE `libros` (
  ...
  `deterioro` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_id_autor_idx` (`id_autor`),
  KEY `fk_id_editorial_idx` (`id_editorial`),
  CONSTRAINT `fk_id_autor` FOREIGN KEY (`id_autor`) REFERENCES `autores` (`id`),
  CONSTRAINT `fk_id_editorial` FOREIGN KEY (`id_editorial`) REFERENCES `editoriales` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prestamos` (
  ...
  CONSTRAINT `fk_id_socio` FOREIGN KEY (`id_socio`) REFERENCES `socios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-02-26 10:52:06
